...
public class CollectionServiceImpl implements CollectionService {
    ...
    public ArrayList<ExistCollectionManagerModel> getFileManagerCollectionsByCollection(String collection) throws IOException, JDOMException {
        ...
        for (ExistCollectionManagerModel col: Mappers.mapCollectionQueryResult(existDbCollectionManagerQueries.getCollectionContent(ExistDbCredentialsServiceImpl.getDetails(), collection))) {
            if(!col.isResource())
                collections.add(col);
        }
        return collections;
    ...
    public ArrayList<ExistCollectionManagerModel> getFileManagerContentByCollection(String collection) throws IOException, JDOMException {
        return Mappers.mapCollectionQueryResult(existDbCollectionManagerQueries.getCollectionContent(ExistDbCredentialsServiceImpl.getDetails(), collection));
    }
    ...
    public ResourceReadModel readFile(String url) throws JDOMException, IOException {
        String content = existDbCollectionManagerQueries.readResource(ExistDbCredentialsServiceImpl.getDetails(), url);
